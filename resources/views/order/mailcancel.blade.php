<h1>ยกเลิกซื้อหมายเลขจาก : Shop {{ $order->id }}, คุณ {{ $order->user->name }} เบอร์ที่ท่านสั่งซื้อ {{ $order->number }} กับทางร้าน</h1>
<div class="table-responsive">
    <table class="table">
        <tbody>
            ...
            <tr><th>อีเมล์ลูกค้า</th><td> {{ $order->user->email }} </td></tr>
