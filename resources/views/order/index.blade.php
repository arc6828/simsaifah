                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Number</th><th>Price</th><th>Total</th><th>Status</th><th>Operator</th><th>Remake</th><th>User Id</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($order as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->number }}</td><td>{{ $item->price }}</td><td>{{ $item->total }}</td><td>{{ $item->status }}</td><td>{{ $item->operator }}</td><td>{{ $item->remake }}</td><td>{{ $item->user_id }}</td>
                                        <td>
