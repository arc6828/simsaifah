                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> {{ $user->name }} </td></tr><tr><th> Role </th><td> {{ $user->role }} </td></tr><tr><th> Email </th><td> {{ $user->email }} </td></tr><tr><th> Email Verified At </th><td> {{ $user->email_verified_at }} </td></tr><tr><th> Password </th><td> {{ $user->password }} </td></tr><tr><th> User Id </th><td> {{ $user->user_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
